...
function ImagesGallery() {
  ...
  useEffect(() => {
    ...
    const apiKey = "734615684822564";
    const apiSecret = "YYFGv5uG6kdzeOl7Ux0NvPBSHE8";
    const cloudName = "dwquti0o1";
    const folder = "products"; // Tên thư mục chứa ảnh bạn muốn lấy.
