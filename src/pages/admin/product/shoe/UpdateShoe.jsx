    ...
    return (
        <>
            <Tooltip placement="bottom" title="Chỉnh sửa sản phẩm">
                <Button type="primary" className="bg-blue" onClick={showModal}><i className="fas fa-edit me-1"></i></Button>
            </Tooltip>
            <Modal title="Cập nhật thông tin sản phẩm" open={isModalOpen} onCancel={handleCancel} footer="">
                <Form onFinish={handleOk} layout="vertical" initialValues={{
                    ...
                    <div className="d-flex justify-content-end align-items-center">
                        <Button type="primary" htmlType="submit" className='bg-blue'><i className="fas fa-edit me-1"></i> Cập nhật</Button>
                    </div>
                </Form>
            </Modal>
